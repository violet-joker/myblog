...
初始化起点到其他点的距离为正无穷，到源点的距离为0，循环n次，**每次寻找未访问过的距离源点最近的点(权值最小的点)，并用该点更新源点到其他点的距离。**dijkstra预处理源点到各点的距离，查表即可。

朴素dijkstra每次暴力搜索最近的点，需要计算n个点到源点的距离,时间复杂度为**O(n^2)**；代码简单，适合稠密图。
